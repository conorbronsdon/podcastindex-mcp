...
An MCP server that connects Claude to the [Podcast Index](https://podcastindex.org/) API. Search podcasts, look up feeds, track host/guest appearances across the ecosystem, monitor trending shows, and browse recent episodes.
